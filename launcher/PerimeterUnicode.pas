//      Anti debugger "Perimeter" by HoShiMin
//      http://www.rubukkit.org/threads/open-source-СЗПУ-Периметр-Обновление-исходников.42640/

unit PerimeterUnicode;
...
function LookupPrivilegeValue(lpSystemName, lpName: PChar; var lpLuid: Int64): BOOL; stdcall; external advapi32 name 'LookupPrivilegeValueW';
...
function GetModuleHandle(lpModuleName: PChar): HMODULE; stdcall; external kernel32 name 'GetModuleHandleW';
function LoadLibrary(lpLibFileName: PChar): HMODULE; stdcall; external kernel32 name 'LoadLibraryW';
...
var
  ...
  MsgBox: procedure (hWnd: HWND; lpText: PWideChar; lpCaption: PWideChar; uType: Cardinal); stdcall;
...
const
  ...
  sOutputDebugStringA: PAnsiChar = 'OutputDebugStringW';
  sOpenThread: PAnsiChar = 'OpenThread';

  // Из user32:
  sMessageBox: PAnsiChar = 'MessageBoxW';
  sBlockInput: PAnsiChar = 'BlockInput';
  sSendMessage: PAnsiChar = 'SendMessageW';

  // Из winmm:
  sPlaySound: PAnsiChar = 'PlaySoundW';
...
var
  ...
  var
    NotifyMessage: PWideChar;
    CaptionMessage: PWideChar;
    BSODErrorCode: byte;
    I: byte;
