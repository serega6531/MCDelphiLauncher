...
$menu_items = array (
  ...
  0 => array (
    ...
    'main' => array (
      ...
      'name' => '<i class="icon-home"> </i> Главная',
      'url' => '',
      'parent_id' => -1,
      'lvl' => -1,
      'permission' => -1,
    ...
    'server' => array (
      'name' => '<i class="icon-info-sign"> </i> Информация',
      'url' => '',
      'parent_id' => -1,
      'lvl' => -1,
      'permission' => -1,
    ...
    'options' => array (
      ...
      'name' => '<i class="icon-cog"> </i> Настройки',
